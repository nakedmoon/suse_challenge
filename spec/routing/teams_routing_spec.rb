...
describe TeamsController do
  describe "routing" do
    ...
    it "routes to nested tasks tasks#index" do
      get("/teams/1/tasks").should route_to("tasks#index", :team_id => "1")
    end

    it "routes to nested mutants mutants#index" do
      get("/teams/1/mutants").should route_to("mutants#index", :team_id => "1")
    end
